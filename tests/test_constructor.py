...
class TestConstructor:
    ...
    def test_switch_to_buns_section(self,driver, user_data):
    ...
    def test_switch_to_fillings_section(self, driver, user_data):
        email, password =  user_data
        self.login(driver, email, password)
    ...
    def test_switch_to_sauces_section(self, driver,  user_data):
        email, password = user_data
        self.login(driver, email, password)
